window.onload = function(){ //Acciones tras cargar la página
    ...
    function numero(xx) { //recoge el número pulsado en el argumento.
             if (x=="0" || xi==1  ) {	// inicializar un número, 
                ...
                if (xx==".") { //si se escribe una coma al principio del número
                   pantalla.innerHTML="0."; //si se escribe 0.
                   x=xx; //guardar número
                   coma=1; //cambiar estado de la coma
                   }
               }
               else { //continuar escribiendo un número
                   if (xx=="." && coma==0) { //si se escribe una coma decimal por primera vez
                ...
                xi=0 //el número está iniciado y se puede ampliarlo.
             }
    function operar(s) {
    ...
    function borradoParcial() {
            ...
            coma=0;	//reiniciar también la coma				
            }
